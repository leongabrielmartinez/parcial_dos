...
plataforma_uno = PlataformaDeslizante((300,60),(500,500), r"recursos\escenario\17_rocas.png", movimiento_x = True, rango = 100)
...
heroe = Heroe((100,100),(50,650), r"recursos\heroe_img\idle\idle_0.png", 10, True, heroe_animaciones)
...
# lista_plataformas_deslizantes = [plataforma_uno]
lista_enemigos = []
lista_items = []
...
while bandera:
    ...
    listas_proyectiles_enemigos = []

    PANTALLA.blit(fondo, (0, 0))

    for plataforma in lista_plataformas:
        if plataforma.es_deslizante:
    ...
    # for i in range(len(lista_plataformas_deslizantes)):
    #     lista_plataformas_deslizantes[i].actualizar(PANTALLA)
    ...
    if obtener_modo():
        ...
        pygame.draw.rect(PANTALLA, "green", plataforma_uno.rect_principal, 3)
        pygame.draw.rect(PANTALLA, "green", plataforma_uno.barrera_uno, 3)
        pygame.draw.rect(PANTALLA, "green", plataforma_uno.barrera_dos, 3)
